...
```{r basics 1}
#1. In task one I gave a name to the sequence and then created the sequence from 1 to 55 but every 5 numbers
sequence1 <- seq(1,55,5)
sequence1

#2. I computed the mean and median of the sequence.
mean_seq <- mean(sequence1)
median_seq<- median(sequence1)

#3. I asked R to tell me if the mean is greater than the median which is false. First created an object that will return if true or false
