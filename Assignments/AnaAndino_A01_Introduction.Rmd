...
> Answer: I have had previous interactions with data analysis but I have not used R or Git before this class. I am very excited to learn.

2. Are there any components of the course about which you feel confident?

> Answer: I m taking this course as starting from zero. However, I am very familiar with types of data for instance as I have worked with primary and secondary data - mostly quantitative.

3. Are there any components of the course about which you feel apprehensive?

> Answer: Learning in a fast pace to code in R since I would like to start coding for research purposes.
...
> Answer: https://github.com/anaandino/anaandino.git
