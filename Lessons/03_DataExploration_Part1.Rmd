...
> ANSWER: 
Fromhttps://help.waterdata.usgs.gov/faq/automated-retrievals
it helps understand the type of data we are suing and that way we can include this file for otehr to be able to reproduce it and understand the types of data, yers collected, any biases, how it was collected ,etc 
...
names(USGS.flow.data) #same as above
...
#head command can be used for knitting but not View
head(USGS.flow.data)
...
> Answer: they will be populates as NA's as we can see when we hit the summary command for some of the variables.
