...
#Option 2; will return true or false. to see if it data frame
...
```{r}
#useful function data.frame(). In here you specify this as colum names
...
head(df,20) #show first 20 rows of df
